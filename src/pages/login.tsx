    ...
    <div className="min-h-screen bg-gray-100 flex justify-center">
      <div className="max-w-screen-xl m-0 sm:m-10 bg-white drop-shadow-lg sm:rounded-lg flex justify-center flex-1">
        ...
        <div className="flex flex-col gap-3 mx-auto lg:w-1/2 p-6 sm:p-12 justify-center items-center"> 
          <h1 className="text-3xl font-semibold mb-4 text-zinc-600 text-center">Welcome to CPE EVO!</h1>
          <h2 className="text-m font-semibold mb-4 text-zinc-400 text-center">The best community of all for us, "CPEs." </h2>
        ...
        <div className="flex flex-col gap-3 mx-auto lg:w-1/2 p-6 sm:p-12 justify-center items-center">
          <div className="bg-white w-2/3 h-2/3 shadow-2xl rounded-xl p-8 flex flex-col justify-center items-center">
            {/* User Icon */}
          <HiUserCircle className="w-24 h-24 mb-6 text-zinc-500" />
            {/* Sign In */}
            <h2 className="text-2xl font-bold text-zinc-600 mb-6">Sign in</h2>
            <div className="w-full max-w-sm flex flex-col gap-4">
              <div className="">
                <Input label="Student ID" type="text" value={user} onChange={(e)=>setUser(e.target.value)}/>
              </div>
              <div className="">
                  <Input
                        label="password"
